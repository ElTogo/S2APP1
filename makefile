graphicus-01: forme.o couche.o canevas.o tests.o graphicus-01.o rectangle.o
	g++ -o graphicus-01 graphicus-01.o forme.o couche.o canevas.o tests.o rectangle.o
